...
void md5DualInput(const uint8_t* data1, int32_t data1Len, const uint8_t* data2, int32_t data2Len, uint8_t* digest) {
    MD5_CTX md5_ctx;
    md5_init(&md5_ctx);
...
void md5Vector(const uint8_t* dataInput[], const int32_t* dataLength, int32_t numberOfElements, uint8_t* digest) {
    MD5_CTX md5_ctx;
    int i;
    md5_init(&md5_ctx);
